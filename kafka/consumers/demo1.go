...
func init() {
	...
	flag.StringVar(&group, "group", "groupid", "Kafka consumer group definition")
	flag.StringVar(&version, "version", "2.1.1", "Kafka cluster version")
	flag.StringVar(&topics, "topics", "topic1", "Kafka topics to be consumed, as a comma seperated list")
